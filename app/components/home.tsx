        ...
        <div className="flex h-[calc(100vh-60px)] overflow-auto bg-white text-black flex-row">
            ...
            <div className="w-1/3 m-20 mt-20">
                <div className='flex flex-row'>
                    ...
                    <Image className='relative invert-25 bottom-1.5' alt={"Logo"} key={"Logo"} width={60} height={60} src={`/logo.webp`}/>
                </div>
            ...
            <Tooltip delayShow={500} style={{backgroundColor: 'white', "--rt-opacity": 1, color: "black", paddingTop: 0, paddingBottom: 0, paddingLeft: 5, paddingRight: 5}} id="double-click-video" />
        </div>
    );
}